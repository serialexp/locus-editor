...
use locus_tools::{EdgeHit, PointKind, SelectState, VertexRef};
...
enum CanvasContextAction {
    SetVertexMode(VertexRef, locus_geom::VertexMode),
    DeleteVertex(VertexRef),
    ConvertSegment(EdgeHit, locus_tools::SegmentKind),
